...
class MELevantamientoController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myService = servicesDao.getServiceByCode(code2: "melevantamiento")
...
extension MELevantamientoController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
