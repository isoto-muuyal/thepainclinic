...
class MEReafirmacionBrazosController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myService = servicesDao.getServiceByCode(code2: "mereafirmacionb")
        print("AparatologiaController loaded")
...
extension MEReafirmacionBrazosController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
