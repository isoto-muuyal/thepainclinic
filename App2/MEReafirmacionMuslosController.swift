//
//  MERefirmacionMuslosController.swift
//  App2
//
...
class MEReafirmacionMuslosController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myService = servicesDao.getServiceByCode(code2: "mereafirmacionm")
        print("MEReafirmacionMuslosController loaded")
...
extension MEReafirmacionMuslosController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
