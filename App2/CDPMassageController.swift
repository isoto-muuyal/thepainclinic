...
class CDPMassageController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myService = servicesDao.getServiceByCode(code2: "cddmassage")
...
extension CDPMassageController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
