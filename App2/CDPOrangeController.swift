...
class CDPOrangeController:UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myService = servicesDao.getServiceByCode(code2: "cddorange")
...
extension CDPOrangeController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
